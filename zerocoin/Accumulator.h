...
public:
	 ...
	 */
	AccumulatorWitness(const Params* p, const Accumulator& checkpoint, const PublicCoin coin);//accumulater can be the old witness so donnot need to calculate again, it is the new witness
